 ...
 * 
 * <h1>An Item received from a node (via {@link LeafNode#getItems()} or {@link LeafNode#addItemEventListener(sdk.org.jivesoftware.smackx.pubsub.listener.ItemEventListener)}</b>
