...
import com.chatsdk.org.jivesoftware.smack.packet.DefaultPacketExtension;
import com.chatsdk.org.jivesoftware.smack.packet.IQ;
...
import com.chatsdk.org.jivesoftware.smack.packet.PacketExtension;
import com.chatsdk.org.jivesoftware.smack.packet.Presence;
import com.chatsdk.org.jivesoftware.smack.packet.Registration;
import com.chatsdk.org.jivesoftware.smack.packet.RosterPacket;
import com.chatsdk.org.jivesoftware.smack.packet.StreamError;
import com.chatsdk.org.jivesoftware.smack.packet.XMPPError;
import com.chatsdk.org.jivesoftware.smack.provider.IQProvider;
...
public class PacketParserUtils {
    ...
    public static Message.SeenState getN(String v){
		for(Message.SeenState state:Message.SeenState.values()){
			try{
			if(state.ordinal()== Integer.parseInt(v))
				return state;
			}catch(NumberFormatException e){}
		}
		return Message.SeenState.sent;
	}
    public static Message.XMPPMessageType getXMPPMessageType(String v){
		for(Message.XMPPMessageType state:Message.XMPPMessageType.values()){
			try{
			if(state.ordinal()== Integer.parseInt(v))
				return state;
			}catch(NumberFormatException e){}
    ...
    public static Packet parseMessage(XmlPullParser parser) throws Exception {
        ...
        message.setGroupOwnerName(parser.getAttributeValue("", "groupowner"));
        message.setPicId(parser.getAttributeValue("", "picid"));
        message.setGroupPicId(parser.getAttributeValue("", "groupPicId"));
        message.setGroupmemberCount(parser.getAttributeValue("", "memberCount"));
        message.setGroupId(parser.getAttributeValue("", "groupId"));
...
//                Log.d("PacketParserUtils: ", "PacketParserUtils parseMessage tag names: "+elementName);
...
//
//                     String body = parseContent(parser);
//                     	Log.d("PacketParserUtils: ", "PacketParserUtils Attribute media: "+body);
                	MediaBody media = message.new MediaBody();
                	media.setType(parser.getAttributeValue("", "type"));
                	media.setUrl(parser.getAttributeValue("", "url"));
...
//        for(int i=0;i<parser.getAttributeCount();i++){
//        	Log.d("PacketParserUtils: ", "parsePresence Attribute names: "+parser.getAttributeName(i)+": "+parser.getAttributeValue("", parser.getAttributeName(i)));
//        }
        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                String elementName = parser.getName();
//                Log.d("PacketParserUtils: ", "PacketParserUtils parsePresence tag names: "+elementName);
                String namespace = parser.getNamespace();
...
//        IQ.Type seenType = IQ.Type.fromString(parser.getAttributeValue("", "status"));
        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                String elementName = parser.getName();
//                Log.d("PacketParserUtils: ", "PacketParserUtils parseIQ tag names: "+elementName);
                String namespace = parser.getNamespace();
        ...
        while (true) {
            ...
            if (eventType == XmlPullParser.START_TAG && parser.getName().equals("property")) {
                ...
                while (!done) {
                    ...
                    if (eventType == XmlPullParser.START_TAG) {
                        String elementName = parser.getName();
//                        Log.d("PacketParserUtils: ", "parseProperties parseIQ tag names: "+elementName);
