...
public class AttentionExtension implements PacketExtension {
     ...
     * (non-Javadoc)
     * 
     * @see sdk.org.jivesoftware.smack.packet.PacketExtension#getElementName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see sdk.org.jivesoftware.smack.packet.PacketExtension#getNamespace()
     */
     ...
     * (non-Javadoc)
     * 
     * @see sdk.org.jivesoftware.smack.packet.PacketExtension#toXML()
     */
    public String toXML() {
...
s     */
    public static class Provider implements PacketExtensionProvider {
         ...
         * 
         * @see
         * sdk.org.jivesoftware.smack.provider.PacketExtensionProvider#parseExtension
