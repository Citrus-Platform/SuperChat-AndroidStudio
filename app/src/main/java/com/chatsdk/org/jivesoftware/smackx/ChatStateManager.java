...
import com.chatsdk.org.jivesoftware.smack.util.collections.ReferenceMap;
import com.chatsdk.org.jivesoftware.smack.filter.PacketFilter;
import com.chatsdk.org.jivesoftware.smack.filter.NotFilter;
 ...
 *
 * NOTE: {@link sdk.org.jivesoftware.smackx.ChatStateManager#getInstance(sdk.org.jivesoftware.smack.Connection)}
 ...
 * @see sdk.org.jivesoftware.smackx.ChatState
 * @see sdk.org.jivesoftware.smackx.packet.ChatStateExtension
 */
public class ChatStateManager {
     ...
     * packet with the state attached as a {@link sdk.org.jivesoftware.smack.packet.PacketExtension}, if
     * and only if the new chat state is different than the last state.
     *
     * @param newState the new state of the chat
     * @param chat the chat.
     * @throws sdk.org.jivesoftware.smack.XMPPException
