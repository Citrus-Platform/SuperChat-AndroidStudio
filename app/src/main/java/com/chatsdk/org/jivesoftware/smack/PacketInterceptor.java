 ...
 * together with a {@link sdk.org.jivesoftware.smack.filter.PacketFilter} so that only
 ...
 *
 * @see Connection#addPacketInterceptor(PacketInterceptor, sdk.org.jivesoftware.smack.filter.PacketFilter)
