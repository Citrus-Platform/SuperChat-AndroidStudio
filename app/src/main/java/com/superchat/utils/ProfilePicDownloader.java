 ...
 */
public class ProfilePicDownloader {
...
//    }
    ...
    public void download(String url, RoundedImageView imageView, ProgressBar pb) {
    	resetPurgeTimer();
//    	String localPath = getBitmapFromCache(url);
    	
//    	if (localPath == null) {
    		processing.put(url, "true");
    		forceDownload(url, imageView, pb);
//    	} else {
////    		cancelPotentialDownload(url, imageView, pb);
...
//    	}
     ...
     * Kept private at the moment as its interest is not clear.
     */
    private void forceDownload(String url, RoundedImageView imageView, ProgressBar pb) {
...
//            imageView.setImageDrawable(null);
        ...
        if (cancelPotentialDownload(url, imageView, pb)) {
            switch (mode) {
//                case NO_ASYNC_TASK:
...
//    }
     ...
     */
    private boolean cancelPotentialDownload(String url, ImageView imageView, ProgressBar pb) {
...
//    }
    ...
    class BitmapDownloaderTask extends AsyncTask<String, Integer, String> {
        ...
        private final WeakReference<ProgressBar> progressbar = null;

        public BitmapDownloaderTask(RoundedImageView imageView, ProgressBar pb) {
        	if(imageView!=null)
