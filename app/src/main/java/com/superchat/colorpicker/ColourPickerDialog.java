package com.superchat.colorpicker;
...
public class ColourPickerDialog {
	...
	final View viewHue;
	final ColourPickerSquare viewSatVal;
	...
	/**
	 * Create an ColourPickerDialog.
	 *
	 * @param context activity context
	 * @param color current color
	 * @param listener an OnAmbilWarnaListener, allowing you to get back error or OK
	 */
	public ColourPickerDialog(final Context context, int color, OnAmbilWarnaListener listener) {
	 ...
	 * @param listener an OnAmbilWarnaListener, allowing you to get back error or OK
	 */
	public ColourPickerDialog(final Context context, int color, boolean supportsAlpha, OnAmbilWarnaListener listener) {
		...
		viewSatVal = (ColourPickerSquare) view.findViewById(R.id.ambilwarna_viewSatBri);
		...
		if (supportsAlpha) viewAlphaCheckered.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				|| (event.getAction() == MotionEvent.ACTION_UP)) {
					...
					ColourPickerDialog.this.setAlpha(a);

					// update view
					moveAlphaCursor();
					int col = ColourPickerDialog.this.getColor();
		...
		.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				if (ColourPickerDialog.this.listener != null) {
					ColourPickerDialog.this.listener.onOk(ColourPickerDialog.this, getColor());
				}
			}
		})
		...
		vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
			...
			public void onGlobalLayout() {
				moveCursor();
				if (ColourPickerDialog.this.supportsAlpha) moveAlphaCursor();
				moveTarget();
				if (ColourPickerDialog.this.supportsAlpha) updateAlphaView();
