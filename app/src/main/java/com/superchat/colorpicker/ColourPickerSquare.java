...
public class ColourPickerSquare extends View {
	Paint paint;
	Shader luar;
	final float[] color = { 1.f, 1.f, 1.f };

	public ColourPickerSquare(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public ColourPickerSquare(Context context, AttributeSet attrs, int defStyle) {
