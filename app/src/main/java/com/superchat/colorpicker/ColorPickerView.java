...
import com.superchat.ui.OnColorChangedListener;
...
public class ColorPickerView extends View {  
  ...
  public ColorPickerView(Context c, OnColorChangedListener l, int color, int defaultColor) {  
   super(c);  
   mListener = l;  
  ...
  protected void onDraw(Canvas canvas) {  
   ...
   if (Color.red(mCurrentColor) + Color.green(mCurrentColor) + Color.blue(mCurrentColor) < 384)  
    ...
    mPaint.setColor(Color.BLACK);  
   canvas.drawText(getResources().getString(R.string.pick), 74, 340, mPaint);  
   ...
   if (Color.red(mDefaultColor) + Color.green(mDefaultColor)  
    ...
    mPaint.setColor(Color.BLACK);  
   canvas.drawText(getResources().getString(R.string.pick), 202, 340,  
     mPaint);  
  }  
