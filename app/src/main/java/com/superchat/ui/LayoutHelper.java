...
public class LayoutHelper {
    ...
    private static int getSize(float size) {
        return (int) (size < 0 ? size : SuperChatApplication.dp(size));
    }
    ...
    public static FrameLayout.LayoutParams createFrame(int width, float height, int gravity, float leftMargin, float topMargin, float rightMargin, float bottomMargin) {
        ...
        layoutParams.setMargins(SuperChatApplication.dp(leftMargin), SuperChatApplication.dp(topMargin), SuperChatApplication.dp(rightMargin), SuperChatApplication.dp(bottomMargin));
        return layoutParams;
    }
    ...
    public static RelativeLayout.LayoutParams createRelative(float width, float height, int leftMargin, int topMargin, int rightMargin, int bottomMargin, int alignParent, int alignRelative, int anchorRelative) {
        ...
        layoutParams.leftMargin = SuperChatApplication.dp(leftMargin);
        layoutParams.topMargin = SuperChatApplication.dp(topMargin);
        layoutParams.rightMargin = SuperChatApplication.dp(rightMargin);
        layoutParams.bottomMargin = SuperChatApplication.dp(bottomMargin);
        return layoutParams;
    }
